...
public class TestUser {
    ...
    public void testInsert() {
        ...
        if (!driver.getCurrentUrl().equals("http://localhost:8080/user/user")) {
            driver.findElement(By.xpath("//*[@id=\"sidebarMenu\"]/div/ul/li[1]/a")).click();
        } else {
        ...
        try {
            driver.findElement(By.xpath("/html/body/div/div/main/div[2]/button")).click();
            Thread.sleep(500);
    ...
    public void testUpdate() {
        ...
        try {
            driver.findElement(By.xpath("/html/body/div/div/main/div[2]/table/tbody/tr[3]/td[3]/button")).click();
            Thread.sleep(500);
    ...
    public void testDelete() {
        ...
        try {
            Thread.sleep(2000);
            driver.findElement(By.xpath("/html/body/div/div/main/div[2]/table/tbody/tr[1]/td[3]/a")).click();
            Thread.sleep(50);
